...
export const upgradeOfferEmail = ({ name, unsubscribeUrl }) => ({
  ...
  html: layout(`
    ...
    <p>The free plan gives you 3 analyses. If you have more contracts — past, present, or incoming — the <strong>Solo plan ($9.9/month)</strong> covers 30 analyses and stores everything in one place.</p>
